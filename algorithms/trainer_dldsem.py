...
def trainer_dldsem(args,alg_options,logger):
	# Dawid Skene EM
	train_data=alg_options['train_data']
	y_train=alg_options['y_train']
	annotations_one_hot=alg_options['annotations_one_hot']
	pred,_=dawid_skene_em(annotations_one_hot,y_train,logger)

	logger.info('Training classifier on Dawid Skene EM outputs')
...
def train_val(args,alg_options,logger):
	...
	if args.dataset=='synthetic':
		...
		#model_f = LinearClassifier(args.R,args.K)
