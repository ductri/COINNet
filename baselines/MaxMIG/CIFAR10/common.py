...
from ..global_conf import conf as my_config
...
class Config:
    ...
    # data_root = f'{constants.ROOT}/data/cifar10/raw/'
    device_id = 0
    # annotation_path = f'{constants.ROOT}/data/cifar10/clean/annotations_30000_29-Dec-2023 20:51:28_1.mat'
    experiment_type = 1
    experiment_case = 1

    epoch_num = my_config.train.num_epochs
    # training_size = 50000
    # test_size = 10000
    num_classes = my_config.data.K
    batch_size = my_config.train.batch_size
    left_learning_rate = my_config.train.lr
    right_learning_rate = my_config.train.lr

    expert_num = my_config.data.M
