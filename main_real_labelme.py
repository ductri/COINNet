...
parser.add_argument('--session_id',type=int,help='Session_ID',default=10)


parser.add_argument('--M',type=int,help='No of annotators',default=3)
parser.add_argument('--K',type=int,help='No of classes',default=8)
...
parser.add_argument('--flag_preload_annotations',type=bool,help='True or False (if True, load annotations from file, otherwise generate annotations',\
															default=True)
parser.add_argument('--varepsilon',type=float,help='parameter for class specialists',default=0.1)
parser.add_argument('--lam',type=float,help='Volume regularizer',default=0.2)
...
parser.add_argument('--flag_underparameterized_instance_dep_modeling', type = int, default =1)
parser.add_argument('--instance_dep_percent_estim', type = float, default =0)
...
parser.add_argument('--log_folder',type=str,help='log folder path',default='results/cifar10_real/')
...
log_file_name = args.log_folder+'log_'+str(time_now.strftime("%b-%d-%Y"))+'_real_cifar10_'+str(args.session_id)+'.txt'
result_file=args.log_folder+'result_'+str(time_now.strftime("%b-%d-%Y"))+'_real_cifar10_'+str(args.session_id)+'.txt'
